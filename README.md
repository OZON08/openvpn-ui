...
> [!NOTE]
> The InfluxDB v3 writer has been verified against **InfluxDB 3 Core** (`influxdb:3-core`).
> SQLite remains the source of truth; InfluxDB is a best-effort export channel for Grafana.
